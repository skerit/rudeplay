 ...
 */
var Session = Fn.inherits('Informer', 'Develry.Rudeplay.Server', function Session(req) {
...
Session.setMethod(function createAlacDecoder() {
	...
	this.alac_decoder_stream = new Rudeplay.Server.AlacDecoderStream(this);
	...
	if (target) {
		this.alac_decoder_stream.pipe(target);
	}
	...
	this.rudeplay.emit('alac_decoder_stream', this.alac_decoder_stream, this);
