...
Session.setMethod(function _retransmit(seq, callback) {
	...
	console.log('Requesting client to re-transmit', seq, 'as control nr', control_nr);
	console.log('To', this.client_transport.control_port, this.rtp_server.remote_info.address);
